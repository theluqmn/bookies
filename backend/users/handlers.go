...
func SignUpHandler(c echo.Context) error {
	...
	if q1 == "" {
		...
		return c.JSON(400, "ID must be between 4 and 16 characters long")
	}
	id = q1
	...
	if q2 == "" {
		...
		return c.JSON(400, "name must be between 4 and 32 characters long")
	}
	name = q2
	...
	if q3 == "" {
		...
		return c.JSON(400, "password must be between 8 and 32 characters long")
	}
	password = q3
